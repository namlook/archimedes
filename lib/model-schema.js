...
var ModelSchema = (function () {
    ...
    _createClass(ModelSchema, [{
        ...
        value: function __buildProperties() {
            ...
            try {
                for (var _iterator = _getIterator(this.modelClass.mixinsChain), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    try {
                        for (var _iterator2 = _getIterator(_Object$keys(mixinProperties)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    ...
                    try {
                        for (var _iterator3 = _getIterator(_Object$keys(mixinRelationships)), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                            var propName = _step3.value;

                            var property = new _modelSchemaProperty2['default'](propName, mixinRelationships[propName], this, true);
