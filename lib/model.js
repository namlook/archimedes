...
var modelFactory = function modelFactory(db, name, modelClassSchema) {
    ...
    if (error) {
        ...
        if (!_lodash2.default.includes(path, '.')) {
            path = '';
        }
    ...
    var inner = {
        ...
        create: function create(pojo) {
            var cleanPojo = _lodash2.default.omitBy(pojo, _lodash2.default.isUndefined);
            return _lodash2.default.assign({}, (0, _modelInstance2.default)(db, this, cleanPojo), methods);
        },
        ...
        mixedWith: function mixedWith() {
            ...
            _lodash2.default.forOwn(this.db.registeredModels, function (model, modelName) {
                if (_lodash2.default.includes(model.mixinsChain, modelName)) {
