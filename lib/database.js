...
exports['default'] = function (dbAdapter, config) {
    ...
    var inner = {
         ...
         */
        writableStream: function writableStream(modelType) {
            var db = this;
        ...
        csvStreamParse: function csvStreamParse(modelType, stream, options) {
            ...
            var csv2pojoTransform = _eventStream2['default'].map(function (pojo, callback) {
                ...
                try {
                    for (var _iterator8 = _getIterator(_Object$keys(pojo)), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                            ...
                            if (!_lodash2['default'].contains(['_id', '_type'], propertyName)) {
                                ...
                                if (property.isRelation()) {
                                    if (property.isArray()) {
                                        ...
                                        try {
                                            for (var _iterator9 = _getIterator(value.split('|')), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
