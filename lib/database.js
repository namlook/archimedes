    ...
    var inner = {
                ...
                if (error) {
                    ...
                    if (virtuosoFix) {
                        process.nextTick(function () {
                            _this3.validate(modelType, pojo, options).then(function (validatedPojo) {
        ...
        find: function find(modelType, query, options) {
            ...
            return _bluebird2['default'].resolve().then(function () {
                ...
                var _queryValidator = (0, _queryValidator7['default'])(_this6[modelType].schema, query);
        ...
        count: function count(modelType, query) {
            ...
            return _bluebird2['default'].resolve().then(function () {
                ...
                var _queryValidator3 = (0, _queryValidator7['default'])(_this9[modelType].schema, query);
        ...
        aggregate: function aggregate(modelType, aggregator, query, options) {
            ...
            return _bluebird2['default'].resolve().then(function () {
                ...
                var modelClass = _this10[modelType];
                var _iteratorNormalCompletion8 = true;
                var _didIteratorError8 = false;
                var _iteratorError8 = undefined;

                try {
                    for (var _iterator8 = _getIterator(_Object$keys(aggregator)), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                        ...
                        if (_lodash2['default'].isObject(value)) {
                            ...
                            try {
                                for (var _iterator10 = _getIterator(_Object$keys(value)), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
                                    ...
                                    if (!(operator === '$count' && propertyName === true)) {
                                        if (!modelClass.schema.getProperty(propertyName)) {
                                            var ispecialProperty = _lodash2['default'].contains(['_id', '_type'], propertyName) || _lodash2['default'].endsWith(propertyName, '._id') || _lodash2['default'].endsWith(propertyName, '._type');
                                            if (!ispecialProperty) {
                            ...
                            if (!modelClass.schema.getProperty(value)) {
                                var ispecialProperty = _lodash2['default'].contains(['_id', '_type'], value) || _lodash2['default'].endsWith(value, '._id') || _lodash2['default'].endsWith(value, '._type');
                                if (!ispecialProperty) {
                ...
                var _queryValidator4 = (0, _queryValidator7['default'])(_this10[modelType].schema, query);
                ...
                if (_lodash2['default'].get(options, 'sort', []).length) {
                    ...
                    try {
                        for (var _iterator9 = _getIterator(options.sort), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                            var variable = _step9.value;

                            if (variable[0] === '-') {
                                variable = variable.slice(1);
                            }
                            if (_Object$keys(aggregator).indexOf(variable) === -1) {
                ...
                return _this10.adapter.aggregate(modelType, aggregator, validatedQuery, options);
            });
        },
        ...
        groupBy: function groupBy(modelType, aggregator, query, options) {
            ...
            return _bluebird2['default'].resolve().then(function () {
                ...
                var modelSchema = _this11[modelType].schema;
                var _iteratorNormalCompletion11 = true;
                var _didIteratorError11 = false;
                var _iteratorError11 = undefined;

                try {
                    for (var _iterator11 = _getIterator(validatedAggregator.property), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
                ...
                var _queryValidator5 = (0, _queryValidator7['default'])(_this11[modelType].schema, query);
                ...
                try {
                    for (var _iterator12 = _getIterator(_lodash2['default'].get(options, 'sort', [])), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
                        var propertyName = _step12.value;

                        var property = _this11[modelType].schema.getProperty(propertyName);
                        if (!property) {
                ...
                return _this11.adapter.groupBy(modelType, validatedAggregator, validatedQuery, options);
            });
        },
        ...
        update: function update(modelType, modelId, operations) {
            ...
            return _bluebird2['default'].resolve().then(function () {
                ...
                return _this12._validateOperations(modelType, operations);
            }).then(function (validatedOperations) {
                return _this12.adapter.update(modelType, modelId, validatedOperations);
            });
        },
        ...
        sync: function sync(modelType, pojo, options) {
            ...
            return _bluebird2['default'].resolve().then(function () {
                ...
                return _this13.validate(modelType, pojo, options);
            }).then(function (validatedPojo) {
                return _this13.adapter.sync(modelType, validatedPojo);
            });
        },
        ...
        _batchSync: function _batchSync(modelType, data) {
            ...
            return _bluebird2['default'].resolve().then(function () {
                ...
                return _this14.adapter.batchSync(modelType, pojos);
            });
        },
        ...
        batchSync: function batchSync(modelType, data) {
            ...
            return _bluebird2['default'].resolve().then(function () {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    promises.push(_this15.validate(modelType, pojo));
                }
                ...
                return new _bluebird2['default'](function (resolve, reject) {
                    ...
                    var writeStream = _this15.writableStream(modelType);
        ...
        'delete': function _delete(modelType, modelId) {
            ...
            return _bluebird2['default'].resolve().then(function () {
                ...
                return _this16.adapter['delete'](modelType, modelId);
            });
        },
        ...
        clearResource: function clearResource(modelType) {
            ...
            return _bluebird2['default'].resolve().then(function () {
                ...
                return _this17.adapter.clearResource(modelType);
            });
        },
        ...
        csvStreamParse: function csvStreamParse(modelType, stream, options) {
            ...
            var csv2pojoTransform = _eventStream2['default'].map(function (pojo, callback) {
                ...
                try {
                    for (var _iterator13 = _getIterator(_Object$keys(pojo)), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
                            ...
                            if (!_lodash2['default'].contains(['_id', '_type'], propertyName)) {
                                ...
                                if (property.isRelation()) {
                                    if (property.isArray()) {
                                        ...
                                        try {
                                            for (var _iterator14 = _getIterator(value.split('|')), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
