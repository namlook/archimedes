...
exports.instanceStreamWriter = exports.rdfStreamWriter = exports.instance2triples = exports.deleteCascade = exports.constructWhereTriples = exports.constructTriples = exports.query2whereClause = exports.pojo2triples = exports.rdfDoc2pojo = exports.operation2triple = exports.uri2property = exports.uri2id = exports.buildRdfValue = exports.propertyName2Sparson = exports.propertyRdfUri = exports.instanceRdfUri = exports.classRdfUri = undefined;
...
var classRdfUri = exports.classRdfUri = function classRdfUri(modelClass) {
    return modelClass.meta.classRdfUri;
};

var instanceRdfUri = exports.instanceRdfUri = function instanceRdfUri(modelClass, id) {
    return modelClass.meta.instanceRdfPrefix + '/' + id;
};

var propertyRdfUri = exports.propertyRdfUri = function propertyRdfUri(modelClass, propertyName) {
    if (!modelClass) {
...
var propertyName2Sparson = exports.propertyName2Sparson = function propertyName2Sparson(modelClass, propertyNames) {
...
var buildRdfValue = exports.buildRdfValue = function buildRdfValue(db, modelType, propertyName, value) {
    ...
    if (_lodash2.default.has(value, '_id') && _lodash2.default.has(value, '_type')) {
        ...
        if (_lodash2.default.includes(['date', 'datetime'], propertyType)) {
            rdfValue = _n.Util.createLiteral((0, _moment2.default)(value).toISOString(), 'http://www.w3.org/2001/XMLSchema#dateTime');
        } else {
            rdfValue = _n.Util.createLiteral(value);
        }
    }
...
var uri2id = exports.uri2id = function uri2id(modelClass, uri) {
    var id = uri.replace(modelClass.meta.instanceRdfPrefix, '');
    return _lodash2.default.trim(id, '/');
};

var uri2property = exports.uri2property = function uri2property(modelClass, uri) {
...
var operation2triple = exports.operation2triple = function operation2triple(db, modelType, uri, operation) {
    var modelClass = db[modelType];
...
var rdfDoc2pojo = exports.rdfDoc2pojo = function rdfDoc2pojo(db, modelType, rdfDoc) {
    var modelClass = db[modelType];
...
var pojo2triples = exports.pojo2triples = function pojo2triples(db, modelType, pojo) {
    var modelClass = db[modelType];
...
var query2whereClause = exports.query2whereClause = function query2whereClause(db, modelType, query, options) {
    var modelClass = db[modelType];
    ...
    _lodash2.default.forOwn(query, function (object, propertyName) {
        ...
        _lodash2.default.forOwn(object, function (value, operator) {
            ...
            var isDate = false;
            if (property) {
                isDate = _lodash2.default.includes(['date', 'datetime'], property.type);
            }
...
var constructTriples = exports.constructTriples = function constructTriples(modelClass, uri, options) {
    return _constructTriple(modelClass, uri, options, false);
};

var constructWhereTriples = exports.constructWhereTriples = function constructWhereTriples(modelClass, uri, options) {
    return _constructTriple(modelClass, uri, options, true);
};

var deleteCascade = exports.deleteCascade = function deleteCascade(db, _modelType, uri) {
    ...
    try {
        for (var _iterator = deleteProps[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var prop = _step.value;


            var variable = void 0;
            var predictate = void 0;
            var type = void 0;
...
var instance2triples = exports.instance2triples = function instance2triples(instance, graphUri) {
        ...
        for (var _iterator2 = Object.keys(properties)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            ...
            if (value != null) {
                ...
                if (_lodash2.default.isArray(value)) {
                    ...
                    var _object = buildRdfValue(Model.db, Model.name, propertyName, value);
                    triples.push({
                        subject: subject,
                        predicate: predicate,
                        object: _object,
...
var rdfStreamWriter = exports.rdfStreamWriter = function rdfStreamWriter(graphUri) {
    return _eventStream2.default.map(function (instance, callback) {
        var writer = (0, _n.Writer)({ format: 'application/trig' });
        ...
        try {
            for (var _iterator4 = instance2triples(instance, graphUri)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
var instanceStreamWriter = exports.instanceStreamWriter = function instanceStreamWriter(db, resourceName) {
