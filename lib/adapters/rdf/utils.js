...
var instance2triples = function instance2triples(instance) {
    ...
    try {
        for (var _iterator2 = _getIterator(_Object$keys(instance.Model.schema._properties)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
