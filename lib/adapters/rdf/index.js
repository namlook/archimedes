        ...
        return {
            ...
            aggregate: function aggregate(modelType, aggregator, query, options) {
                ...
                return _bluebird2['default'].resolve().then(function () {
                    ...
                    var orderBy = _lodash2['default'].get(options, 'sort', []).map(function (variable) {
                    ...
                    try {
                        for (var _iterator2 = _getIterator(_Object$keys(aggregator)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                            ...
                            var propertyName = aggregator[variable];
                    ...
                    try {
                        for (var _iterator5 = _getIterator(data), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                            ...
                            try {
                                for (var _iterator6 = _getIterator(_Object$keys(item)), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                                    ...
                                    var property = variablePropertyMap[variable];
            ...
            groupBy: function groupBy(modelType, aggregator, query, options) {
                ...
                return _bluebird2['default'].resolve().then(function () {
                    ...
                    try {
                        for (var _iterator7 = _getIterator(propertyNames), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                            var propertyName = _step7.value;
                    ...
                    try {
                        for (var _iterator8 = _getIterator(_lodash2['default'].get(options, 'sort', [])), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                    ...
                    return _this8.execute(sparql).then(function (data) {
                        ...
                        var computeResult = function computeResult(_data, variables) {
                            ...
                            try {
                                for (var _iterator9 = _getIterator(_data), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                            ...
                            try {
                                for (var _iterator10 = _getIterator(_Object$keys(_results)), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
