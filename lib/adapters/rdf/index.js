        ...
        return {
            ...
            groupBy: function groupBy(modelType, aggregator, query, options) {
                ...
                return _bluebird2['default'].resolve().then(function () {
                    ...
                    try {
                        for (var _iterator2 = _getIterator(propertyNames), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    ...
                    try {
                        for (var _iterator3 = _getIterator(_lodash2['default'].get(options, 'sort', [])), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                    ...
                    return _this7.execute(sparql).then(function (data) {
                        ...
                        var computeResult = function computeResult(_data, variables) {
                            ...
                            try {
                                for (var _iterator4 = _getIterator(_data), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                            ...
                            try {
                                for (var _iterator5 = _getIterator(_Object$keys(_results)), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
